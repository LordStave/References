package de.lordstave.mongostats.util;
...
public class UUIDFetcher {
    ...
    public static void getUUID(String name, Consumer<UUID> action) {
        Main.getInstance().getDatabaseHandler().executeAsync(() -> action.accept(getUUID(name)));
    }
    ...
    public static void getUUIDAt(String name, long timestamp, Consumer<UUID> action) {
        Main.getInstance().getDatabaseHandler().executeAsync(() -> action.accept(getUUIDAt(name, timestamp)));
    }
    ...
    public static void getName(UUID uuid, Consumer<String> action) {
        Main.getInstance().getDatabaseHandler().executeAsync(() -> action.accept(getName(uuid)));
    }
